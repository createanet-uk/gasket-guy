...
// //         }
// //
// //         // Insert into report_assets using the Seal ID (Normalized)
// //         await _supabase.from('report_assets').insert({
// //           'report_id': reportId,
// //           'area': asset.area,
  ...
  Future<void> _handleSubmitReport() async {
    ...
    try {
      ...
      for (var asset in _assets) {
        ...
        // B. Insert the Asset record into 'report_assets'
        final assetResponse = await _supabase.from('report_assets').insert({
          'report_id': reportId,
          'area': asset.area,
          'data_plate_url': dataPlateUrl,
          'manufacturer': asset.brand,
