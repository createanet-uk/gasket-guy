...
// // //
// // //       final fileName =
// // //           'fridge_plates/${DateTime.now().millisecondsSinceEpoch}.jpg';
// // //
// // //       // -----------------------------------
// // //       // UPLOAD TO STORAGE
// // //       // -----------------------------------
...
// // //         Uri.parse(
// // //           'https://brrdkdabcoilwebmbrlx.supabase.co/functions/v1/extract-fridge-plate',
// // //         ),
// // //         headers: {
...
// // //
// // //         _entry.doorCount =
// // //             extracted["door_count"] ?? 0;
// // //
// // //         _entry.drawerCount =
// // //             extracted["drawer_count"] ?? 0;
// // //       });
// // //
// // //       _syncIndividualItemsList();
// // //
...
// // //         const SnackBar(
// // //           content: Text(
// // //             "Fridge data extracted successfully",
// // //           ),
// // //         ),
// // //       );
// // //     } catch (e) {
...
//     }
//   }
//   // 1. Method to open the ML Scanner
//   void _showSealDetection(int index) async {
//     final result = await showModalBottomSheet<SealDetectionResult>(
//       context: context,
//       isScrollControlled: true,
...
//         }
//       });
//       // Now trigger the specs lookup
//       _autoFillFromDatabase(result.label, index);
//     }
//   }
//
//   // 2. Method to lookup seal specs from local database
//   Future<void> _autoFillFromDatabase(String sealLabel, int index) async {
//     try {
//       final prefs = await SharedPreferences.getInstance();
//       final String? productsJson = prefs.getString('local_products');
...
//           item.sealName = product['title'];
//
//           // Map technical values to the item
//           item.isMagnetic = product['is_magnetic'] ?? false;
//           item.sealType = product['seal_type'] ?? '';
//           item.material = product['material'] ?? '';
//           item.hardness = product['hardness'] ?? '';
...
//           item.description = product['description'] ?? '';
//
//           // Force the TextControllers on the UI card to update
//           item.updateControllers();
//         });
//       }
//     } catch (e) {
//       debugPrint("Auto-fill specs error: $e");
//     }
//   }
//
//   void _showFridgeSelection(List<Map<String, dynamic>> matches) async {
...
//                   final f = item['fridge'];
//                   final r = item['rel'];
//                   String sealModel = r != null && r['seal_products'] != null ? r['seal_products']['seal_model_number'] ?? 'N/A' : 'N/A';
//                   String location = r != null ? r['location'] ?? 'Universal' : 'General';
//
//                   return ListTile(
//                     leading: const Icon(Icons.kitchen, color: AppTheme.primary),
//                     title: Text("${f['brand'] ?? f['manufacturer']} - ${f['model_no']}"),
...
//       List<dynamic> fridgeRelations = allRelations.where((r) => r['fridge_id'] == fridge['id']).toList();
//
//       List<dynamic> targetRelations = selectedRelationId != null
//           ? fridgeRelations.where((r) => r['id'] == selectedRelationId).toList()
//           : fridgeRelations;
//
//       setState(() {
//         _entry.fridgeId = fridge['id'];
...
//         }
//       } else {
//         setState(() => _extractionError = "Could not read plate. Please type Model No. manually to find seals.");
//       }
//     } catch (e) {
//       setState(() => _extractionError = "Scan failed. You can search by typing Model No. manually below.");
//     } finally {
//       if (mounted) {
//         setState(() => _isExtracting = false);
//         _scanController.stop();
...
//   }
//
//   void _showFullScreenImage(String path, {bool isFile = true}) {
//     showDialog(
//       context: context,
...
//                 width: double.infinity,
//                 height: double.infinity,
//                 child: isFile ? Image.file(File(path), fit: BoxFit.contain) : Image.network(path, fit: BoxFit.contain),
//               ),
//             ),
...
//                 children: [
//                   GestureDetector(
//                     onTap: () => _showFullScreenImage(_entry.dataPlateImage!.path, isFile: true),
//                     child: Image.file(_entry.dataPlateImage!, width: double.infinity, height: double.infinity, fit: BoxFit.contain),
//                   ),
//                   if (_isExtracting) _buildScanningOverlay(),
//                   if (!_isExtracting)
//                     Positioned(
//                       top: 8, right: 8,
//                       child: GestureDetector(
...
//                       decoration: BoxDecoration(
//                         color: AppTheme.primary,
//                         boxShadow: [BoxShadow(color: AppTheme.primary.withOpacity(0.6), blurRadius: 12, spreadRadius: 2)],
//                       ),
//                     ),
//                   ),
//                 ],
...
//               const SizedBox(width: 12),
//               Expanded(child: Text(_extractionError!, style: TextStyle(color: Colors.amber[900], fontSize: 13, fontWeight: FontWeight.w500))),
//             ],
//           ),
...
//             label: const Text("TYPE MODEL NO. MANUALLY"),
...
//       child: Column(
//         children: [
//           TextField(controller: _brandController, decoration: const InputDecoration(labelText: "Brand / Manufacturer", isDense: true)),
//           const SizedBox(height: 8),
//           TextField(
//             controller: _modelController,
//             decoration: InputDecoration(
...
//           ),
//           const SizedBox(height: 8),
//           TextField(controller: _serialController, decoration: const InputDecoration(labelText: "Serial Number", isDense: true)),
//         ],
//       ),
//     );
//   }
...
//                     padding: const EdgeInsets.only(right: 8),
//                     child: GestureDetector(
//                       onTap: () => _showFullScreenImage(item.images[i].path, isFile: true),
//                       child: ClipRRect(borderRadius: BorderRadius.circular(8), child: Image.file(item.images[i], width: 80, height: 80, fit: BoxFit.cover)),
//                     ),
//                   ),
//                 ),
