...
//       if (savedModelPath != null && File(savedModelPath).existsSync()) {
//         print(
//             'HOMEPAGE_LOAD: Loading dynamic model from $savedModelPath (v$version)');
//         interpreter = await Interpreter.fromFile(File(savedModelPath));
//       } else {
//         print('HOMEPAGE_LOAD: No dynamic model found, loading from assets...');
//         interpreter =
...
//       return "Add images to start analysis";
//     } else if (imageFiles.length < minimumImages) {
...
//                 // Force run even with fewer images
//                 _forceRunInference();
//               },
//               child: Text(
//                 "Analyze Anyway",
...
//     setState(() {
//       isBusy = true;
//       statusMessage = "Analyzing (fewer images may reduce accuracy)...";
//     });
//
//     try {
//       List<List<double>> allScores = [];
...
//
//             // Minimum images tip
//             if (imageFiles.isNotEmpty && imageFiles.length < minimumImages)
...
//
//             // Error
//             if (!isBusy && !isInitializing && isUnmatched) _buildErrorCard(),
//
//             // Results
//             if (!isBusy &&
//                 !isInitializing &&
...
//           //   ),
//           //   child:
//           //   const Icon(Icons.precision_manufacturing, color: Colors.white, size: 18),
//           // ),
...
//             ),
//             child: Icon(
//               isEnough ? Icons.check_circle_outline : Icons.photo_library,
...
//                     fontWeight: FontWeight.bold,
//                     fontSize: 14,
//                     color: isEnough ? Colors.green[800] : Colors.orange[800],
//                   ),
//                 ),
...
//                   style: TextStyle(
//                     fontSize: 11,
//                     color: isEnough ? Colors.green[600] : Colors.orange[600],
//                   ),
//                 ),
//               ],
//             ),
...
//               label: Text("Gallery",
//                   style: TextStyle(
//                       fontWeight: FontWeight.w600, color: Colors.indigo[600])),
//               style: OutlinedButton.styleFrom(
...
//         boxShadow: [
//           BoxShadow(
//             color: (isEnough ? Colors.green : Colors.orange).withOpacity(0.3),
//             blurRadius: 10,
//             offset: const Offset(0, 4),
//           ),
//         ],
...
//         onPressed: runMultiInference,
//         icon: Icon(
//           isEnough ? Icons.analytics_rounded : Icons.warning_amber_rounded,
//           size: 22,
//         ),
//         label: Column(
//           children: [
...
//   // =============================================
//
//   Widget _buildResultTile(PredictionResult res,
//       {required int rank, required bool isHighlyRecommended}) {
//     Color rankColor;
//     IconData rankIcon;
//
//     switch (rank) {
...
//                     borderRadius: BorderRadius.circular(10),
//                   ),
//                   child: Icon(rankIcon, size: 20, color: rankColor),
//                 ),
//                 const SizedBox(width: 12),
//
//                 // Label
...
//                           fontSize: 16,
//                           color:
//                           isHighlyRecommended ? Colors.indigo : Colors.black87,
//                         ),
//                       ),
//                       if (isHighlyRecommended)
//                         Container(
